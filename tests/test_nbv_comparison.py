...
def test_nbv_exceeds_as_is_true():
    val = apply_nbv_comparison(_valuation(200, 220, 400, 440))
...
def test_nbv_exceeds_as_is_false():
    val = apply_nbv_comparison(_valuation(500, 550, 300, 330))
...
def test_just_above_ten_percent_tolerance_flagged():
    val = apply_nbv_comparison(_valuation(100, 100, 110.1, 110.1, fx=1.0))
    assert val.nbv_exceeds_as_is is True
